...
namespace Assets.CaseFile.Components
{
    public class FemurStem : Implant
    {
        ...
        public Vector3 StemAxis
        {
            get
            {
                return (this["StemAxisSuperior"].Position - this["InferiorPoint"].Position);
            }
        }
        public Vector3 NeckAxis
        {
            get
            {
                return (this["TrunnionPoint"].Position - this["NeckAxisInferior"].Position);
            }
        }

        public Plane ResectionPlane
        {
            get
            {
                Plane p = new Plane();
                p.Set3Points(
                    this["ResectionPlaneSuperior"].Position,
                    this["ResectionPlaneInferior"].Position,
                    this["ResectionPlane3"].Position);
                return p;
            }
        }
