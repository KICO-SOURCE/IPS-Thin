    ...
    public class NativeViewport : Viewport
    {
        ...
        public override void CreateViews()
        {
            if (patient.Landmarks.Any(lm => lm.Type == "femoralCenter"))
            {
                ...
                coronalFemurView.InitialiseView(meshes, ViewType.CoronalView, origin, siAxis, mlAxis, apAxis, "Femur");
                axialFemurView.InitialiseView(meshes, ViewType.AxialView, origin, siAxis, mlAxis, apAxis, "Femur");
                ...
                coronalTibiaView.InitialiseView(meshes, ViewType.CoronalView, origin, siAxis, mlAxis, apAxis, "Tibia");
                sagittalTibiaView.InitialiseView(meshes, ViewType.SagittalView, origin, siAxis, mlAxis, apAxis, "Tibia");
            }
            base.CreateViews();
        }
