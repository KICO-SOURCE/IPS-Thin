...
public class DataModels{
	//Document URL: https://spreadsheets.google.com/feeds/worksheets/1fpBGo7hQpEnZXkKum5zoSxR9pTVJC0vlve2er2ygtNI/public/basic?alt=json-in-script
	...
	static DataModels(){
		...
		measurements.Init(); landmarks.Init(); 
	}
}
...
namespace DataModelsTypes{
	...
	public class SheetMeasurements: IEnumerable{
		public System.DateTime updated = new System.DateTime(2021,6,30,5,30,42);
		public readonly string[] labels = new string[]{"id","type","landmarks[] points"};
		private Measurements[] _rows = new Measurements[4];
		public void Init() {
...
namespace DataModelsTypes{
	...
	public class SheetLandmarks: IEnumerable{
		public System.DateTime updated = new System.DateTime(2021,6,30,5,30,43);
